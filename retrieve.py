...
vectorstore = Chroma(persist_directory='test_db', embedding_function=embedding)
text_splitter = RecursiveCharacterTextSplitter(chunk_size=1000)
text_file_path = 'docs\\genaral_info.txt'

with open(text_file_path, "r", encoding="utf-8") as text_file:
    # print(text_file.read())
    # print(type(text_file.read()))
    doc = Document(
...
final_doc = []
for doc in docs:
    final_doc.append(Document(page_content=doc))
vectorstore.add_documents(documents=final_doc)

query = """
Địa chỉ cụ thể của FPT tại Việt Nam là gì ?
"""
